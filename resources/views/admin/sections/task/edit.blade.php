                    ...
                    <div class="col-md-8">
                        <div class="card elevation-0">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-tasks"></i> Edit a task</h3>
                            ...
                            <form action="{{route('admin.task.update' ,$task)}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="priority" name="priority" class="form-control"
                                                    ...
                                                    @foreach($priorities as $priority)
                                                        <option
                                                            value="{{$priority}}" {{in_array($task->priority, [$priority]) ? 'selected' : ''}}>{{$priority}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('priority')
                                ...
                                <div class="card-footer">
                                    <div class="float-right">
                                        <button class="btn btn-info"><i class="fas fa-save"></i> Update Task</button>
                                    </div>
                                </div>
                            </form>
                        </div>
